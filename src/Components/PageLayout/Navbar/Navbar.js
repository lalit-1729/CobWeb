...
function Navbar(){
    ...
    return(
        <div className="rounded md:col-span-1 m-3 bg-gray-800">
            <nav >
                <div className="flex justify-between border-b border-gray-100 md:flex md:justify-center items-center">
                ...
                <ul className="text-left hidden md:block" id="menu">
                    ...
                    <li className="flex flex-row text-gray-400 text-xl px-6 pb-6">
                        ...
                        <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
